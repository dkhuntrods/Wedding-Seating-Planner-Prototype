define(["./edit/EditShapeWithGuestsView", "./room/RootRoomView", "./room/RoomDimensionsView", "./room/UnitsView", "./shapes/FurnitureListView", "./guests/GuestsSeatedView",
		"app/factories/EditShapeWithGuestsFactory", "app/factories/RoomContainerFactory", "app/factories/FurnitureListItemFactory",
		"libs/Backbone.Framework"], 

function(EditShapeWithGuestsView, RootRoomView, RoomDimensionsView, UnitsView, FurnitureListView, GuestsSeatedView,
	EditShapeWithGuestsFactory, RoomContainerFactory, FurnitureListItemFactory) {
